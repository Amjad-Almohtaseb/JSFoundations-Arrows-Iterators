 ...
 ************************************/
const logger =  (array) =>array.forEach((elemnt)=>console.log(elemnt));
 ...
 ***************************************/
const hottestDays =  (temperatures, threshhold)=> temperatures.filter((temperature)=> temperature>threshhold);
